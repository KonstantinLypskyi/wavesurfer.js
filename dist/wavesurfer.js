/*!
 * wavesurfer.js 2.1.2 (2019-01-22)
...
function (_util$Observer) {
  ...
  _createClass(Drawer, [{
    ...
    key: "progress",
    value: function progress(_progress, time) {
...
function (_Drawer) {
  ...
  _createClass(MultiCanvas, [{
    ...
    value: function createElements() {
      ...
      this.cursorBlock = this.wrapper.appendChild(this.style(document.createElement('div'), {
        position: 'absolute',
        zIndex: 5,
        left: 0,
        height: '100%'
      }));
      this.customCursor = this.cursorBlock.appendChild(this.style(document.createElement('canvas'), {
        position: 'absolute',
        left: 0,
        background: 'red',
        width: '4px',
      ...
      this.customTimer = this.cursorBlock.appendChild(this.style(document.createElement('div'), {
        position: 'absolute',
        zIndex: 6,
        left: 0
      }));
      this.customTimer.className = 'custom_timer';
      this.customTimer.innerHTML = '00:00'; // const ctx = this.customCursor.getContext('2d');
    ...
    key: "transformSec",
    value: function transformSec(sec) {
      if (sec < 3600) {
        return (0, _moment.default)('1900-01-01 00:00:00').add(sec, 'seconds').format('mm:ss');
      }

      return (0, _moment.default)('1900-01-01 00:00:00').add(sec, 'seconds').format('HH:mm:ss');
    }
    /**
     * Render the new progress
     *
    ...
    key: "updateProgress",
    value: function updateProgress(position, time) {
      this.customTimer.innerHTML = "".concat(this.transformSec(Math.floor(time)));
      this.style(this.cursorBlock, {
        left: position + 'px'
      });
      this.style(this.progressWave, {
        width: position + 'px'
  ...
  _createClass(WaveSurfer, [{
    ...
    value: function createBackend() {
      ...
      this.backend.on('audioprocess', function (time) {
        _this6.drawer.progress(_this6.backend.getPlayedPercents(), time);
